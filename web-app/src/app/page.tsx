...
import { convertHtmlCssToFigma } from '../lib/figma-converter';
  ...
  return (
    <main className="p-8">
      ...
      <p className="text-gray-600 mb-6">
        This tool converts HTML and CSS into a Figma through plugin. This website is a demo of the html and css is transformed</p>
